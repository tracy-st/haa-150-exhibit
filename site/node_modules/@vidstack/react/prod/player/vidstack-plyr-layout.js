...
import { useMediaState, Primitive, IS_SERVER, isRemotionSrc, getDownloadFile } from '../chunks/vidstack-D5Pzx_k5.js';
import * as React from 'react';
import { createDisposalBin, effect, uppercaseFirstChar, isUndefined, signal, composeRefs, useSignal, isNumber, isString, listenEvent, isKeyboardEvent, isKeyboardClick } from '../chunks/vidstack-CZgUA94N.js';
import { useMediaContext, PlayButton, Root, Img, AirPlayButton, CaptionButton, FullscreenButton, PIPButton, SeekButton, Root$1, Value, Preview, Thumbnail, appendParamsToURL, Gesture, Root$2, Button, Items, useAudioOptions, Root$3, Item, useCaptionOptions, Time, LiveButton, MuteButton, Root$4 } from '../chunks/vidstack-CQ3Bde2N.js';
import { useMediaRemote, usePlaybackRateOptions, useVideoQualityOptions } from '../chunks/vidstack-CEWbu4SL.js';
import { useLayoutName, useClassName } from '../chunks/vidstack-DzQtn4XB.js';
