...
import { IS_SERVER, useMediaState, isRemotionSrc, Primitive, useSliderState } from '../chunks/vidstack-DUlCophs.js';
export { isRemotionProvider } from '../chunks/vidstack-DUlCophs.js';
...
class RemotionProviderLoader {
  ...
  async load(ctx) {
    return new (await import('../chunks/vidstack-DBQelZDZ.js')).RemotionProvider(this.target, ctx);
  }
}
