...
var EMPTY_PROPS = {};
var _a2, _setupCallbacks, _attachCallbacks, _connectCallbacks, _destroyCallbacks, _Instance_instances, attachAttrs_fn, attachStyles_fn, setAttr_fn, setStyle_fn;
_a2 = ON_DISPATCH;
var Instance = class {
...
attachAttrs_fn = function() {
  ...
  for (const name of Object.keys(this.attrs)) {
    if (IS_SERVER) {
      ...
      effect(__privateMethod(this, _Instance_instances, setAttr_fn).bind(this, name));
    } else {
...
attachStyles_fn = function() {
  ...
  for (const name of Object.keys(this.styles)) {
    if (IS_SERVER) {
      ...
      effect(__privateMethod(this, _Instance_instances, setStyle_fn).bind(this, name));
    } else {
...
var ViewController = class extends EventTarget {
  ...
  dispatch(type, ...init) {
    ...
    return untrack(() => {
      var _a3, _b2;
      (_b2 = (_a3 = this.$$)[ON_DISPATCH]) == null ? void 0 : _b2.call(_a3, event);
    ...
    for (const name of [...prevPropNames, ...newPropNames]) {
      if (options.props.has(name)) {
        state.component.$props[name].set(
          ...
          isUndefined(renderProps[name]) ? (_a3 = Component2.props) == null ? void 0 : _a3[name] : renderProps[name]
        );
      } else if (((_b2 = options.events) == null ? void 0 : _b2.has(name)) || ((_c = options.eventsRE) == null ? void 0 : _c.test(name))) {
        state.callbacks[name] = renderProps[name];
      } else if (((_d = options.domEvents) == null ? void 0 : _d.has(name)) || ((_e = options.domEventsRE) == null ? void 0 : _e.test(name))) {
        let type = camelToKebabCase(name.slice(2));
        state.domCallbacks[type] = renderProps[name];
        if (!newPropNames.includes(name)) {
          (_f = state.el) == null ? void 0 : _f.removeEventListener(type, state.onDOMEvent);
          (_g = state.listening) == null ? void 0 : _g.delete(type);
        } else if (state.el && !((_h = state.listening) == null ? void 0 : _h.has(type))) {
...
function createInternalState() {
  const state = {
    ...
    onDOMEvent(event) {
      ...
      (_b2 = (_a3 = state.domCallbacks)[event.type]) == null ? void 0 : _b2.call(_a3, ...args);
    }
  };
  return state;
}
...
var ServerClassList = class {
  ...
  toggle(token, force) {
    if (force !== true && (__privateGet(this, _tokens3).has(token) || force === false)) {
      __privateGet(this, _tokens3).delete(token);
      return false;
    } else {
      __privateGet(this, _tokens3).add(token);
...
function createServerComponent(Component2, options) {
  function ServerComponent(props) {
    let scope = React.useContext(ReactScopeContext), component = createComponent(Component2, {
      props,
      scope: scope.current
    }), host = new MaverickServerElement(component), attrs = {}, { style = {}, children, forwardRef: forwardRef2, ...renderProps } = props;
...
//# sourceMappingURL=chunk-BWS7LCCC.js.map
