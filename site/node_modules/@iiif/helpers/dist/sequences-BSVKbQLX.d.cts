import { CompatVault } from "./compat-BjbLsHFh.cjs";
import { Reference } from "@iiif/presentation-3";
import { ManifestNormalized, RangeNormalized } from "@iiif/presentation-3-normalized";

//#region src/sequences.d.ts
declare function createSequenceHelper(vault?: CompatVault): {
 ...
 *
 */
declare function getVisibleCanvasesFromCanvasId(vault: CompatVault | undefined, manifestOrRange: ManifestNormalized | RangeNormalized, canvasId: string | null, preventPaged?: boolean): Reference<'Canvas'>[];
declare function getManifestSequence(vault: CompatVault | undefined, manifestOrRange: ManifestNormalized | RangeNormalized, {
  disablePaging,
  skipNonPaged
}?: {
  disablePaging?: boolean;
...
//# sourceMappingURL=sequences-BSVKbQLX.d.cts.map