...
import * as typesafe_actions0 from "typesafe-actions";
...
declare const importEntities: typesafe_actions0.PayloadActionCreator<"@iiif/IMPORT_ENTITIES", {
  entities: Partial<Entities>;
}>;
declare const modifyEntityField: typesafe_actions0.PayloadActionCreator<"@iiif/MODIFY_ENTITY_FIELD", {
  type: keyof Entities;
  id: string;
  key: string;
  value: any;
}>;
declare const reorderEntityField: typesafe_actions0.PayloadActionCreator<"@iiif/REORDER_ENTITY_FIELD", {
  type: keyof Entities;
  id: string;
  key: string;
  startIndex: number;
...
declare const moveEntity: typesafe_actions0.PayloadActionCreator<"@iiif/MOVE_ENTITY", {
  subject: {
    id: string;
    type: keyof Entities;
    index?: number;
...
declare const moveEntities: typesafe_actions0.PayloadActionCreator<"@iiif/MOVE_ENTITIES", {
  subjects: {
    type: 'list';
    items: Array<{
      id: string;
...
declare const addReference: typesafe_actions0.PayloadActionCreator<"@iiif/ADD_REFERENCE", {
  type: keyof Entities;
  id: string;
  key: string;
...
declare const removeReference: typesafe_actions0.PayloadActionCreator<"@iiif/REMOVE_REFERENCE", {
  type: keyof Entities;
  id: string;
  key: string;
  index?: number | undefined;
...
declare const updateReference: typesafe_actions0.PayloadActionCreator<"@iiif/UPDATE_REFERENCE", {
  type: keyof Entities;
  id: string;
  key: string;
  index: number;
...
declare const addMetadata: typesafe_actions0.PayloadActionCreator<"@iiif/ADD_METADATA", {
  id: string;
  type: keyof Entities;
...
declare const updateMetadata: typesafe_actions0.PayloadActionCreator<"@iiif/UPDATE_METADATA", {
  id: string;
  type: keyof Entities;
...
declare const removeMetadata: typesafe_actions0.PayloadActionCreator<"@iiif/REMOVE_METADATA", {
  id: string;
  type: keyof Entities;
  atIndex: number;
}>;
declare const reorderMetadata: typesafe_actions0.PayloadActionCreator<"@iiif/REORDER_METADATA", {
  id: string;
  type: keyof Entities;
  startIndex: number;
  endIndex: number;
...
declare const entityActions: {
  importEntities: typesafe_actions0.PayloadActionCreator<"@iiif/IMPORT_ENTITIES", {
    entities: Partial<Entities>;
  }>;
  modifyEntityField: typesafe_actions0.PayloadActionCreator<"@iiif/MODIFY_ENTITY_FIELD", {
    type: keyof Entities;
    id: string;
    key: string;
    value: any;
  }>;
  reorderEntityField: typesafe_actions0.PayloadActionCreator<"@iiif/REORDER_ENTITY_FIELD", {
    type: keyof Entities;
    id: string;
    key: string;
    startIndex: number;
  ...
  addReference: typesafe_actions0.PayloadActionCreator<"@iiif/ADD_REFERENCE", {
    type: keyof Entities;
    id: string;
    key: string;
    index?: number | undefined;
  ...
  removeReference: typesafe_actions0.PayloadActionCreator<"@iiif/REMOVE_REFERENCE", {
    type: keyof Entities;
    id: string;
    key: string;
    index?: number | undefined;
  ...
  updateReference: typesafe_actions0.PayloadActionCreator<"@iiif/UPDATE_REFERENCE", {
    type: keyof Entities;
    id: string;
    key: string;
    index: number;
  ...
  addMetadata: typesafe_actions0.PayloadActionCreator<"@iiif/ADD_METADATA", {
    id: string;
    type: keyof Entities;
    beforeIndex?: number | undefined;
    label: InternationalString;
  ...
  removeMetadata: typesafe_actions0.PayloadActionCreator<"@iiif/REMOVE_METADATA", {
    id: string;
    type: keyof Entities;
    atIndex: number;
  }>;
  updateMetadata: typesafe_actions0.PayloadActionCreator<"@iiif/UPDATE_METADATA", {
    id: string;
    type: keyof Entities;
    atIndex?: number | undefined;
    label: InternationalString;
  ...
  reorderMetadata: typesafe_actions0.PayloadActionCreator<"@iiif/REORDER_METADATA", {
    id: string;
    type: keyof Entities;
    startIndex: number;
    endIndex: number;
  }>;
  moveEntity: typesafe_actions0.PayloadActionCreator<"@iiif/MOVE_ENTITY", {
    subject: {
      id: string;
      type: keyof Entities;
      index?: number;
  ...
  moveEntities: typesafe_actions0.PayloadActionCreator<"@iiif/MOVE_ENTITIES", {
    subjects: {
      type: 'list';
      items: Array<{
        id: string;
...
declare const addMapping: typesafe_actions0.PayloadActionCreator<"@iiif/ADD_MAPPING", {
  id: string;
  type: string;
}>;
declare const addMappings: typesafe_actions0.PayloadActionCreator<"@iiif/ADD_MAPPINGS", {
  mapping: {
    [id: string]: string;
  };
}>;
declare const mappingActions: {
  addMapping: typesafe_actions0.PayloadActionCreator<"@iiif/ADD_MAPPING", {
    id: string;
    type: string;
  }>;
  addMappings: typesafe_actions0.PayloadActionCreator<"@iiif/ADD_MAPPINGS", {
    mapping: {
      [id: string]: string;
    };
  }>;
...
declare const metaActions: {
  setMetaValue: typesafe_actions0.PayloadActionCreator<"@iiif/SET_META_VALUE", {
    id: string;
    meta: string;
    key: string;
    value: any;
  }>;
  setMetaValueDynamic: typesafe_actions0.PayloadActionCreator<"@iiif/SET_META_VALUE_DYNAMIC", {
    id: string;
    meta: string;
    key: string;
    updateValue: (oldValue: any) => any;
  }>;
  unsetMetaValue: typesafe_actions0.PayloadActionCreator<"@iiif/UNSET_META_VALUE", {
    id: string;
    meta: string;
    key: string;
  }>;
...
declare const requestResource: typesafe_actions0.PayloadActionCreator<"@iiif/REQUEST_RESOURCE", {
  id: string;
}>;
declare const requestError: typesafe_actions0.PayloadActionCreator<"@iiif/REQUEST_ERROR", {
  id: string;
  message: string;
}>;
declare const requestMismatch: typesafe_actions0.PayloadActionCreator<"@iiif/REQUEST_MISMATCH", {
  requestId: string;
  actualId: string;
}>;
declare const requestComplete: typesafe_actions0.PayloadActionCreator<"@iiif/REQUEST_COMPLETE", {
  id: string;
}>;
declare const requestOfflineResource: typesafe_actions0.PayloadActionCreator<"@iiif/REQUEST_OFFLINE_RESOURCE", {
  id: string;
  entity: unknown;
}>;
declare const requestActions: {
  requestResource: typesafe_actions0.PayloadActionCreator<"@iiif/REQUEST_RESOURCE", {
    id: string;
  }>;
  requestError: typesafe_actions0.PayloadActionCreator<"@iiif/REQUEST_ERROR", {
    id: string;
    message: string;
  }>;
  requestMismatch: typesafe_actions0.PayloadActionCreator<"@iiif/REQUEST_MISMATCH", {
    requestId: string;
    actualId: string;
  }>;
  requestComplete: typesafe_actions0.PayloadActionCreator<"@iiif/REQUEST_COMPLETE", {
    id: string;
  }>;
  requestOfflineResource: typesafe_actions0.PayloadActionCreator<"@iiif/REQUEST_OFFLINE_RESOURCE", {
    id: string;
    entity: unknown;
  }>;
};
...
declare const batchActions: typesafe_actions0.PayloadActionCreator<"@iiif/BATCH", {
  actions: AllActions[];
}>;
declare const batchImport: typesafe_actions0.PayloadActionCreator<"@iiif/BATCH_IMPORT", {
  state: EntityStore;
}>;
...
//# sourceMappingURL=batch-actions-D7V5t4hj.d.cts.map