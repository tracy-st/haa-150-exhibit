...
export declare type CanvasNormalized = OmitProperties<TechnicalProperties, CanvasOmittedTechnical> & OmitProperties<DescriptiveNormalized, CanvasOmittedDescriptive> & OmitProperties<StructuralNormalized<Reference<"AnnotationPage">>, CanvasOmittedStructural> & OmitProperties<LinkingNormalized, CanvasOmittedLinking> & NavPlaceExtension & {
	type: "Canvas";
};
export type NormalizedCollectionItemSchemas = Reference<"Collection"> | Reference<"Manifest">;
export declare type CollectionNormalized = OmitProperties<TechnicalProperties, CollectionOmittedTechnical> & OmitProperties<DescriptiveNormalized, CollectionOmittedDescriptive> & OmitProperties<StructuralNormalized<NormalizedCollectionItemSchemas>, CollectionOmittedStructural> & OmitProperties<LinkingNormalized, CollectionOmittedLinking> & NavPlaceExtension & {
	type: "Collection";
};
export declare type ContentResourceNormalized = ContentResource;
export declare type ManifestNormalized = OmitProperties<TechnicalProperties, ManifestOmittedTechnical> & OmitProperties<DescriptiveNormalized, ManifestOmittedDescriptive> & StructuralNormalized<Reference<"Canvas">> & OmitProperties<LinkingNormalized, ManifestOmittedLinking> & NavPlaceExtension & {
	"@context"?: string | string[];
	type: "Manifest";
};
export type NormalizedRangeItemSchemas = Reference<"Range"> | SpecificResource<Reference<"Canvas">>;
export declare type RangeNormalized = OmitProperties<TechnicalProperties, RangeOmittedTechnical> & OmitProperties<DescriptiveNormalized, RangeOmittedDescriptive> & OmitProperties<StructuralNormalized<NormalizedRangeItemSchemas>, RangeOmittedStructural> & OmitProperties<LinkingNormalized, RangeOmittedLinking> & NavPlaceExtension & {
	type: "Range";
};
